...
/****** Object:  StoredProcedure [dbo].[Day4Part1]    Script Date: 12/4/2022 8:15:33 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE    PROCEDURE [dbo].[Day4Part1]
	@DayNum int = 4
	, @InputType varchar(7) = 'EXAMPLE'
AS
BEGIN
	/*	
		EXEC Day4Part1 @InputType = 'EXAMPLE';
		EXEC Day4Part1 @InputType = 'PUZZLE';
		EXEC Day4Part1;
	*/
	...
	SELECT [Procedure] = OBJECT_NAME(@@PROCID)
		...
		, answer = (
			...
			WHERE (
					...
					AND Elf1_End BETWEEN Elf2_Start AND Elf2_End
				)
				OR (
					Elf2_Start BETWEEN Elf1_Start AND Elf1_End
					AND Elf2_End BETWEEN Elf1_Start AND Elf1_End
				)
		)
	;
END
